...
CommunityTypes.Volts.UUID = '00000001-0000-1000-8000-666666666666';
...
CommunityTypes.Amperes.UUID = '00000002-0000-1000-8000-666666666666';
...
CommunityTypes.Watts.UUID = '00000003-0000-1000-8000-666666666666';
...
CommunityTypes.VoltAmperes.UUID = '00000004-0000-1000-8000-666666666666';
...
CommunityTypes.KilowattHours.UUID = '00000005-0000-1000-8000-666666666666';
...
CommunityTypes.KilowattVoltAmpereHour.UUID = '00000006-0000-1000-8000-666666666666';
...
CommunityTypes.AtmosphericPressureLevel.UUID = '00000007-0000-1000-8000-666666666666';
...
CommunityTypes.NoiseLevel.UUID = '00000008-0000-1000-8000-666666666666';
...
CommunityTypes.NoiseDetected = function() {
 ...
 CommunityTypes.NoiseDetected.UUID = '00000009-0000-1000-8000-666666666666';
 inherits(CommunityTypes.NoiseDetected, Characteristic);

 CommunityTypes.PowerMeterDevice = function() {
    Characteristic.call(this, "Noise Detected", CommunityTypes.Timestamp.UUID);
    this.setProps({
      format:   Characteristic.Formats.BOOL,
      perms: [Characteristic.Perms.READ, Characteristic.Perms.NOTIFY]
  ...
  CommunityTypes.PowerMeterDevice.UUID = '00000010-0000-1000-8000-666666666666';
  inherits(CommunityTypes.PowerMeterDevice, Characteristic);
...
CommunityTypes.AtmosphericPressureSensor.UUID = '00000001-000C-1000-8000-666666666666';
...
CommunityTypes.AtmosphericPressureSensor.UUID = '00000002-000C-1000-8000-666666666666';
inherits(CommunityTypes.AtmosphericPressureSensor, Service);
...
CommunityTypes.NoiseSensor.UUID = '00000003-000C-1000-8000-666666666666';
