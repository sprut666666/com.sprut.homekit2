...
function Volts(ID, value, onWrite) {
    var characteristic = new HAS.Characteristic(ID, 'E863F10A-079E-48FF-8F27-9C2605A29F52', 'uint16', false, true, true, true, false, "V", "Volts", 0, 65535, 1, undefined, undefined, undefined);
...
function Amperes(ID, value, onWrite) {
    var characteristic = new HAS.Characteristic(ID, 'E863F126-079E-48FF-8F27-9C2605A29F52', 'uint16', false, true, true, true, false, "A", "Amps", 0, 65535, 1, undefined, undefined, undefined);
    if (value != null && value != undefined)
        characteristic.setValue(value);
    if (onWrite)
        characteristic.onWrite = onWrite;
...
function Watts(ID, value, onWrite) {
    var characteristic = new HAS.Characteristic(ID, 'E863F10D-079E-48FF-8F27-9C2605A29F52', 'uint16', false, true, true, true, false, "W", "Consumption", 0, 65535, 1, undefined, undefined, undefined);
    if (value != null && value != undefined)
        characteristic.setValue(value);
    if (onWrite)
        characteristic.onWrite = onWrite;
...
function VoltAmperes(ID, value, onWrite) {
    var characteristic = new HAS.Characteristic(ID, 'E863F110-079E-48FF-8F27-9C2605A29F52', 'uint16', false, true, true, true, false, "VA", "Apparent Power", 0, 65535, 1, undefined, undefined, undefined);
    if (value != null && value != undefined)
        characteristic.setValue(value);
    if (onWrite)
        characteristic.onWrite = onWrite;
...
function KilowattHours(ID, value, onWrite) {
    var characteristic = new HAS.Characteristic(ID, 'E863F10C-079E-48FF-8F27-9C2605A29F52', 'uint32', false, true, true, true, false, "kWh", "Total Consumption", 0, 65535, 1, undefined, undefined, undefined);
    if (value != null && value != undefined)
        characteristic.setValue(value);
    if (onWrite)
        characteristic.onWrite = onWrite;
...
function KilowattVoltAmpereHour(ID, value, onWrite) {
    var characteristic = new HAS.Characteristic(ID, 'E863F127-079E-48FF-8F27-9C2605A29F52', 'uint32', false, true, true, true, false, "kVAh", "Apparent Energy", 0, 65535, 1, undefined, undefined, undefined);
    if (value != null && value != undefined)
        characteristic.setValue(value);
    if (onWrite)
        characteristic.onWrite = onWrite;
...
function AtmosphericPressureLevel(ID, value, onWrite) {
    var characteristic = new HAS.Characteristic(ID, '28FDA6BC-9C2A-4DEA-AAFD-B49DB6D155AB', 'uint8', false, true, true, true, false, "mbar", "Barometric Pressure", 800, 1200, 1, undefined, undefined, undefined);
    if (value != null && value != undefined)
        characteristic.setValue(value);
    if (onWrite)
        characteristic.onWrite = onWrite;
...
function NoiseLevel(ID, value, onWrite) {
    var characteristic = new HAS.Characteristic(ID, '2CD7B6FD-419A-4740-8995-E3BFE43735AB', 'uint8', false, true, true, true, false, "dB", "Noise Level", 0, 200, 1, undefined, undefined, undefined);
    if (value != null && value != undefined)
        characteristic.setValue(value);
    if (onWrite)
        characteristic.onWrite = onWrite;
