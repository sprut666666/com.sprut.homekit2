  ...
  for (let key in device.capabilities)
    ...
    switch (device.capabilities[key].id)
    {
      ...
      case 'onoff':
        ...
        else
        {
          ...
          if ('dim' in device.capabilities)
          {
            ...
            updateStatusOnHKNoNull(Math.floor(sDV(device.state.dim, 1) * 100), variableState, 'dim', device);
            if (test) testStab(variableState, key, device);
          ...
          if ('light_hue' in device.capabilities)
          {
            ...
            updateStatusOnHKNoNull(Math.floor(sDV(device.state.light_hue, 1) * 360), variableState, 'light_hue', device);
            if (test) testStab(variableState, key, device);
          ...
          if ('light_saturation' in device.capabilities)
          {
            ...
            updateStatusOnHKNoNull(Math.floor(sDV(device.state.light_saturation, 1) * 100), variableState, 'light_saturation', device);
            if (test) testStab(variableState, key, device);
          ...
          if ('light_temperature' in device.capabilities)
          {
            ...
            updateStatusOnHKNoNull(Math.floor(140 + sDV(device.state.light_temperature, 0) * 360), variableState, 'light_temperature', device);
            if (test) testStab(variableState, key, device);
      ...
      case 'measure_humidity':
        ...
        updateStatusOnHKNoNull(Math.floor(sDV(device.state[key], 0)), variableState, key, device);
        if (test) testStab(variableState, key, device);
